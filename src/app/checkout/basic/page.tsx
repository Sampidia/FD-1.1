...
export default function BasicCheckoutPage() {
  ...
  const [pointsToBuy, setPointsToBuy] = useState(100) // Default 100 points
  ...
  const totalAmount = paymentService.calculatePointsAmountForPlan(pointsToBuy, 'basic')
  ...
  const handlePayment = async () => {
    ...
    try {
      const paymentData = {
        ...
        phone: '', // Could be obtained from user profile
      ...
      if (result.success && result.paymentUrl) {
        ...
        localStorage.setItem('planId', 'basic')
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8 text-center">
          <Badge variant="outline" className="mb-4">
            🔄 Upgrade to Premium AI Detection
          </Badge>
          <h1 className="text-3xl font-bold text-gray-900">
            Complete Your Basic Plan Purchase
          </h1>
          <p className="text-lg text-gray-600 mt-2">
            Get started with Google Gemini AI verification and save on every point
          </p>
        </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-3">
                  <div className={`p-3 rounded-full bg-${planData.color}-100`}>
                    <planData.icon className={`w-5 h-5 text-${planData.color}-600`} />
                  </div>
                  <div>
              ...
              <CardContent className="space-y-4">
                ...
                {discountRate > 0 && (
                  <div className="flex justify-between text-green-600">
                    ...
                    <span>-{discountRate.toFixed(0)}%</span>
                  </div>
                )}
